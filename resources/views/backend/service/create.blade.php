                        ...
                        <fieldset>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 div-image">
                                    <input type="hidden" name="image" class="image_data" value="{!!old('image')!!}"/>
                                    <input type="file" id="favicon" onclick="openKCFinder(this)" data-value="{!!old('image')!!}" class="file-input-overwrite" data-field="image">
                                    <p>Chỉ cho phép các file ảnh có đuôi <span class="text-danger">jpg</span>, <span class="text-danger">gif</span> và <span class="text-danger">png</span></p>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input type="file" id="favicon" onclick="openKCFinder(this)" data-value="{!!old('icon')!!}" class="file-input-overwrite" data-field="icon">
