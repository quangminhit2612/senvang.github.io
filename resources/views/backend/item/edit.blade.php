        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <form action="{!!route('admin.item.update', $record->id)!!}" method="POST" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="alias" value="{!!old('alias')?:$record->alias!!}" required="">
